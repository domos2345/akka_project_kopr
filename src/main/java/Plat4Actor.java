...
public class Plat4Actor extends AbstractActor {
    ...
    private void printSensorMessage(TrainMessage trainMessage) {
        ...
        if (train != null) {
            ...
            String fromto = train.isArriving() ? " arrived from station " + train.getFromCity() + " to platform 4" :
                    " departed to station " + train.getToCity() + " from platform 4";
    ...
    public static Props props() {
        return Props.create(Plat4Actor.class);
    }
}
