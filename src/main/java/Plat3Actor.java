...
public class Plat3Actor extends AbstractActor {
    ...
    private void printSensorMessage(TrainMessage trainMessage) {
        ...
        if (train != null && trainMessage.getPlatform() == 3) {
            String message = "___SENSOR MESSAGE START___\n\n";
            String fromto = train.isArriving() ? " arrived from station " + train.getFromCity() + " to platform 3" :
                    " departed to station " + train.getToCity() + " from platform 3";
    ...
    public static Props props() {
        return Props.create(Plat3Actor.class);
    }
}
